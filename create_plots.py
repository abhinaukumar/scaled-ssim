...
for i, model in enumerate(models_dict.keys()):
    ...
    plt.imshow(f[model + '_train_pcc'], vmin=0.8, vmax=1, aspect='equal')
    ...
    plt.imshow(f[model + '_test_pcc'], vmin=0.8, vmax=1, aspect='equal')
...
for i, model in enumerate(models_dict.keys()):
    ...
    plt.subplot(2, n_models, i + 1)
    plt.imshow(f[model + '_train_srocc'], vmin=0.8, vmax=1, aspect='equal')
